...
final class EmbarkationRequestUseCase
{
    public function __construct(
        private readonly EmbarkationUpstreamClient $upstreamClient,
        private readonly EmbarkationResponseNormalizer $responseNormalizer,
    ...
    public function execute(string $requestMethod): array
    {
        ...
        try {
            $rawBody = $this->upstreamClient->requestList();
    ...
    {
        $message = sprintf(
            "hajj_embarkation_internal_error context=%s type=%s message=%s file=%s line=%d",
            $context,
            $throwable::class,
